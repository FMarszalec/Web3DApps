  ...
  <body id="bodyColor">
      ...
      <nav id="headerColor" class="navbar sticky-top navbar-expand-sm navbar_coca_cola">
            ...
            <div class="collapse navbar-collapse">
                ...
                <ul class="navbar-nav ml-auto">
                  ...
                  <!-- Dropdown -->
                  <li class="nav-item">
                      <a id="navModels" class="nav-link"  href="#" data-toggle="popover" data-trigger="hover" data-placement="bottom" title="X3D Models" data-content="There are three X3D models: Fanta, Sprite and Pepper">Models</a>
                  </li>
                  <li class="nav-item">
      ...
      <div class="container-fluid">
          ...
          <div id="home" class="main_contents">
            ...
            <!-- A row to hold three cards for the Fanta, Sprite and Pepper contents -->
            <div class="row">
                  <div class="col-sm-4">
                  ...
                  <div class="col-sm-4">
                      <div class="card img-narrow">
                          <a href="../application/assets/images/renderImages/drpepper.JPG" data-fancybox data-caption="My 3D Pepper Bottle Render" class="thumbnail">
                          ...
                          <x3d id="wire">
                            <scene>
                                <Switch whichChoice="0" id='SceneSwitch'>
                                    <transform>
                                        <inline nameSpaceName="model" mapDEFToID="true" onclick="animateCoke();" url="../application/assets/x3d/coke.x3d" > </inline>
                                    </transform>
                                    <transform>
                                        <inline nameSpaceName="model" mapDEFToID="true" onclick="animateSprite();" url="../application/assets/x3d/sprite.x3d"> </inline>
                                    </transform>
                                    <transform>
                                        <inline nameSpaceName="model" mapDEFToID="true" onclick="animatePepper();" url="../application/assets/x3d/pepper.x3d"> </inline>
                                    </transform>
                                </Switch>
                            </scene>
                          </x3d>
              ...
              <div class="col-sm-12">
                  <div class="card">
                      <div class="card-body">
                        ...
                        <a href="http://www.coca-cola.co.uk/brands/fanta" class="btn btn-primary btn-responsive">Visit Fanta</a>                 
                      </div>
                  </div>
              </div>
      ...
      <nav id="footerColor" class="navbar navbar-expand-sm footer">
          <div class="container-fluid">   
              <div class="navbar-text float-left copyright">
                  <p><span class="align-baseline">&copy 2022 3D Apps | <a href="javascript:changeLook()">Restyle</a> | <a href="javascript:changeBack()">Reset</a> | <a href="https://github.com/TheKlodster/3d_web_applications">Github</a></span></p>
              </div>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                  <p>Candidate Number: 181262, fm321@sussex.ac.uk</p>
                </div>
